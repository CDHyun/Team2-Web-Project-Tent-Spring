				...
				<div class="col-12">
					<div class="shortcodes_title mb-30">
						...
						<div class="shortcodes_content">
							<div class="table-responsive">
								<table class="table mb-0 table-bordered">
									<thead>
										<tr>
											<th scope="col" class="question_title"
												style="vertical-align: middle;">${question.bTitle}</th>
											<th scope="col" class="question_writer"
												style="vertical-align: middle;">${question.uNickName}</th>
						...
						<div id="qna_btn_container">
							...
							<div class="modal" id="questionModifyModal" tabindex="-1" role="dialog">
								<div class="modal-dialog modal-xl" role="document">
									<div class="modal-content modal-xl">
										<div class="row">
							                <div class="col-12">
							                    <div class="shortcodes_title mb-30">
							                        <h4>question Modify</h4>
							                    </div>
							                    <div class="shortcodes_content">
							                        <div class="table-responsive">
		  ...
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      <div class="container">
		        ...
		        <form id="child_comment_form" action="write_child_comment?bNo=${bNo}&cmParentNo=${cmt.cmNo}" method="post">
