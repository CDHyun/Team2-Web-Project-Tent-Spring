...
public class Board {
	...
	public Board(int bNo, String uid, String uNickName, int bCgNo, String bTitle, String bContent, String bInsertDate,
			String bUpdateDate, String bDeleteDate, boolean bDeleted, int bViewCount) {
		super();
		this.bNo = bNo;
		this.uid = uid;
